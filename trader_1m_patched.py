...
def place_order_fail(*a,**k): return {"code":"-1","msg":"OKX unreachable"}
...
def close_position_fail(*a,**k): return {"code":"-1","msg":"OKX unreachable"}
